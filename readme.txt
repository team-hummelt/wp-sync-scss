...
- **Flexible Map Options**: Choose between inline maps, separate maps, or no maps.
...
2. **Settings Page**: Select SCSS and CSS paths
3. **Compiled CSS Output**: Preview of automatically created CSS files.

== Donate ==
Like this plugin? Support the development with a donation:
